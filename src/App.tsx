...
<section className="bg-[#f7f1e8] py-16">    <div className="mx-auto max-w-6xl px-6 text-center">      <p className="mb-4 inline-flex rounded-full bg-[#ead8c2] px-4 py-2 text-sm font-bold text-[#7a4f35]">        Seasonal Outreach      </p>      <h2 className="font-serif text-5xl font-bold leading-tight text-[#2f261f]">        Warmth for Winter: Annual Coat Drive      </h2>      <p className="mx-auto mt-6 max-w-2xl text-xl leading-relaxed text-[#6d5748]">        Help us provide essential warmth to our unhoused neighbors as temperatures drop. We are collecting new and gently used winter coats for all ages. Your donation brings comfort and dignity.      </p>      <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">        <a          href="#donate-coats"          className="inline-flex items-center justify-center gap-2 rounded-full bg-[#7a4f35] px-8 py-3.5 text-lg font-bold text-white shadow-md"        >          Donate a Coat Today        </a>        <a          href="#volunteer"          className="inline-flex items-center justify-center rounded-full border border-[#c9ad96] px-8 py-3.5 text-lg font-bold text-[#7a4f35]"        >          Volunteer to help        </a>      </div>    </div>    <div className="mx-auto mt-12 grid max-w-5xl gap-8 px-6 md:grid-cols-2 lg:grid-cols-3">      <div className="rounded-[2rem] bg-white p-6 shadow-sm">        <h3 className="mb-3 font-serif text-2xl font-bold text-[#2f261f]">What to Donate</h3>        <p className="text-[#6d5748]">          New or gently used winter coats, all sizes (especially adult men's and women's). Please ensure items are clean.        </p>      </div>      <div className="rounded-[2rem] bg-white p-6 shadow-sm">        <h3 className="mb-3 font-serif text-2xl font-bold text-[#2f261f]">Drop-off Locations</h3>        <p className="text-[#6d5748]">          Harbor Hall Community Center, 122 Harbor Street. Look for the "Coat Drive" signage.        </p>      </div>      <div className="rounded-[2rem] bg-white p-6 shadow-sm md:col-span-2 lg:col-span-1">        <h3 className="mb-3 font-serif text-2xl font-bold text-[#2f261f]">Key Dates</h3>        <p className="text-[#6d5748]">          Collection runs from November 1st to December 15th. Distribution begins December 20th.        </p>      </div>    </div>  </section>
